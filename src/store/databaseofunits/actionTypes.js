...
export const GET_METHOD_LIST_SUCCESS =
  "GET_METHOD_LIST_SUCCESS";
export const GET_METHOD_LIST_FAIL = "GET_METHOD_LIST_FAIL";


///adding new METHOD
export const ADD_NEW_METHOD_LIST = "ADD_NEW_METHOD_LIST";
export const ADD_NEW_METHOD_LIST_SUCCESS = "ADD_NEW_METHOD_LIST_SUCCESS";
export const ADD_NEW_METHOD_LIST_FAIL = "ADD_NEW_METHOD_LIST_FAIL";

//update METHOD
export const UPDATE_NEW_METHOD_LIST = "UPDATE_NEW_METHOD_LIST";
export const UPDATE_NEW_METHOD_LIST_SUCCESS = "UPDATE_NEW_METHOD_LIST_SUCCESS";
export const UPDATE_NEW_METHOD_LIST_FAIL = "UPDATE_NEW_METHOD_LIST_FAIL";
