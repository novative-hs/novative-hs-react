...
export const GET_MICROBIOLOGY_DATA = `${API_ENDPOINT}/api/database-admin/get-microbiology`;
export const ADD_MICROBIOLOGY_DATA = `${API_ENDPOINT}/api/database-admin/add-microbiology`;
//Participant
