...
import { getCOfferedPackagesReferrel } from "store/offered-tests/actions";
...
class TestsOffered extends Component {
  ...
  componentDidMount() {
    ...
    const { ongetCOfferedPackegesReferrel } = this.props;
    if (this.state.applied) {
      ongetCOfferedPackegesReferrel();
...
TestsOffered.propTypes = {
  ...
  ongetCOfferedPackegesReferrel: PropTypes.func,
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  ongetCOfferedPackegesReferrel: () =>
    dispatch(getCOfferedPackagesReferrel(ownProps.match.params.lab_account_id)),
