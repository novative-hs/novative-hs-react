                      ...
                      <Card style={{ height: "95%" }}>
                        <CardBody>
                          ...
                          <div className="mt-4 text-center">
                            ...
                            {(nearbyPackage.discount >= 0.01) && ((nearbyPackage.all_discount_by_labhazir + nearbyPackage.discount_by_labhazir) >= 0.01) && (
                              <div className="my-0">
                                ...
                                <span className="text-muted me-2">
                                  {/* <i className="fas fa-money-bill"></i>{" "} */}
                                  Rs {((nearbyPackage.price - (nearbyPackage.discount + nearbyPackage.all_discount_by_labhazir + nearbyPackage.discount_by_labhazir) * nearbyPackage.price).toFixed(2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                </span>
                              </div>
                            )}
                            ...
                            {(nearbyPackage.discount <= 0.01) && ((nearbyPackage.all_discount_by_labhazir + nearbyPackage.discount_by_labhazir) <= 0.01) && (
                              <div className="my-0">
                                <span className="text-muted me-2">
                                  {/* <i className="fas fa-money-bill"></i>{" "} */}
                                  Rs {((nearbyPackage.price).toFixed(2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                </span>
                              </div>
                            )}
