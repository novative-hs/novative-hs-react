...
import { getCOfferedProfilesReferrel } from "store/offered-tests/actions";
...
class TestsOffered extends Component {
  ...
  componentDidMount() {
    ...
    const { ongetCOfferedProfilesReferrel } = this.props;
    if (this.state.applied) {
      ongetCOfferedProfilesReferrel();
...
TestsOffered.propTypes = {
  ...
  ongetCOfferedProfilesReferrel: PropTypes.func,
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  ongetCOfferedProfilesReferrel: () =>
    dispatch(getCOfferedProfilesReferrel(ownProps.match.params.lab_account_id)),
