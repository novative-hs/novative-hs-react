        ...
        },
        {
          ...
          formatter: (cell, row) => (
            <span
              ...
              onClick={() =>
                this.onDeleteRoundParticipant(
                  this.props.roundDetails.round_id,
                  row.id
                )
              }
                            ...
                            <Col xl="12">
                              <div className="table-responsive">
                                <BootstrapTable
                                  ...
                                  responsive
                                  data={this.filterData()} // ✅ now filtered
                                  columns={this.state.feedbackListColumns}
                                />
                              </div>
                            </Col>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  onDeleteRoundParticipant: (roundId, participantId) =>
    dispatch(deleteRoundParticipant(roundId, participantId)),

  // ✅ Ensure it's mapped properly
  deleteParticipantFromLabRound: (participantId) =>
    dispatch({
