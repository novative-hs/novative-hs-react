...
class AccountStatements extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      //   //   formatter: (cellContent, b2baccountStatement) => (
      //   //     <>
      //   //       {b2baccountStatement.paid_at ? (
      //   //         <span>
      //   //           {new Date(b2baccountStatement.paid_at).toLocaleString("en-US")}
      //   //         </span>
      //   //       ) : (
      //   //         <span>Not paid</span>
      //   //       )}
      ...
      //     formatter: (cellContent, b2baccountStatement) => (
      //       <>
      //         {b2baccountStatement.payment_method == "Card" ? (
      //            <span>
      //            {b2baccountStatement.dues}
      //          </span>
      //        ) : (
      //      null
      //         )}
      //         {b2baccountStatement.payment_method == "Donation" ? (
      //           <span>
      //             {b2baccountStatement.dues}
      //           </span>
      //         ) : (
      ...
      //         {b2baccountStatement.payment_method == "Card" ? (
      //           <span>
      //             {b2baccountStatement.Receivable}
      //           </span>
      //         ) : (
      //       null
      //         )}
  ...
  render() {
    ...
    // var total_testby_labhazir = this.props.b2baccountStatements.total_testby_labhazir
