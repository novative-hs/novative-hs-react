    ...
    <div key={index} style={{ marginBottom: "40px" }}>
      ...
      >
        ...
        <div style={{ flex: "1 1 500px" }}>
          <Table bordered style={{ borderCollapse: "collapse", marginBottom: "20px" }}>
          <tbody>
                    {/* Row 1 */}
                    <tr>
                      <td
...
>
  {analyte.evaluation}
        ...
        {/* Graph Section */}
        <div style={{ flex: "1 1 600px", minWidth: "400px", height: "100%" }}>
          {(() => {
            const participantId = this.props.match.params.id1;
            ...
            const allZScores = this.props.reportData.participants_results
              ...
              .map(result => ({
                ...
                id: result.participant_id, // store ID for matching
                ZScore: parseFloat(result.z_score),
              }));

            return allZScores.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
                <BarChart barSize={30} data={allZScores} margin={{ top: 20, right: 30, left: 30, bottom: 50 }}>
  ...
  label={{
    ...
    offset: -5,
    style: { textAnchor: "middle", fontSize: 14 }, // optional styling
  }}
/>
...
/>
                  ...
                  {/* Add ReferenceLine for current participant */}
                  {allZScores.map((entry, idx) =>
