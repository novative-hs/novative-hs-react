...
import { getActivityLogUnits } from "store/units-history/actions";
...
class MsgsList extends Component {
  ...
  componentDidMount() {
    ...
    console.log("in conponent",onGetActivityLogUnits(id, type));
  }
                            ...
                            <CardBody className="p-3">
                              {activitylogUnits.actions === "Updated" && activitylogUnits.type === "Units" && (
                                <div>
                                  ...
                                  at{" "}
                                  {moment(activitylogUnits.date_of_updation).format("DD MMM YYYY, h:mm A")}{" "}
                              ...
                              {activitylogUnits.actions === "Updated" && activitylogUnits.type === "Reagents" && (
                                <div>
                              ...
                              {activitylogUnits.actions === "Added" && activitylogUnits.type === "Reagents" && (
                                <div>
                              ...
                              {activitylogUnits.actions === "Added" && activitylogUnits.type === "Instrumentlist" && (
                                <div>
                                  <b>{`${activitylogUnits.added_by}`}</b> Added a instrument {" "} ID: <b>{`${activitylogUnits.instrument_id}`}</b> {" "} {" "}
                                  <b>{activitylogUnits.new_value}</b>
                                  {" "}at{" "}
                                  {moment(activitylogUnits.date_of_addition).format("DD MMM YYYY, h:mm A")}{" "}
                                  .
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  onGetActivityLogUnits: (id, type) => dispatch(getActivityLogUnits(id, type)), // Pass both id and type
});
