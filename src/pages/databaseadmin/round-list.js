    ...
    <>
        <div style={{ display: "flex", justifyContent: "center", gap: "10px" }}>
          <input
            ...
            onChange={(e) => this.handleFilterChange("closing_dateFilter", e)}
            className="form-control"
            style={{ textAlign: "center", width: "100px" }}
          />
        </div>
    ...
    <>
        <div style={{ display: "flex", justifyContent: "center", gap: "10px" }}>
          <input
            ...
            onChange={(e) => this.handleFilterChange("participantFilter", e)}
            className="form-control"
            style={{ textAlign: "center", width: "100px" }}
          />
        </div>
    ...
    <>
        <div style={{ display: "flex", justifyContent: "center", gap: "10px" }}>
          <input
            ...
            onChange={(e) => this.handleFilterChange("noofresultsFilter", e)}
            className="form-control"
            style={{ textAlign: "center", width: "100px" }}
          />
        </div>
      ...
      <Tooltip title="Delete">
        <Link className="text-danger" to="#">
          <i
            ...
            id="deletetooltip"
            onClick={() => this.onClickDelete(row.id)}  // Use row.id here
          ></i>
        </Link>
      </Tooltip>
    </div>
...
onClickDelete = (rounds) => {
  this.setState({ roundToDelete: rounds });
...
filterData = () => {
  ...
  return rounds.filter(round => {
    const match = (value, filter) =>
      !filter || (value && value.toString().toLowerCase().includes(filter.toLowerCase()));
...
const mapDispatchToProps = dispatch => ({
  ...
  onDeleteCycleRound: rounds => dispatch(deleteCycleRound(rounds)),
});
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CycleRoundList));
