          ...
          <Row className="justify-content-center">
            <Col>
              <Card style={styles.cardContainer}>
                <CardBody>
                  <h1 style={styles.heading}>Welcome to Login Dashboard</h1>
                  <p style={styles.paragraph}>
                  {/* Your role belongs to Registration Admin, */}
                  In which you can Make your Staff like DatabaseAdmin, CSR, RegistrationAdmin, and also you can see and Update your Staff Information.
                  You can see your Associate Participants. 
