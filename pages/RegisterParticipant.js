...
// action
import { addLabInformation, addLabInformationFailed } from "../store/actions";
                            ...
                            <div className="mt-4">
                              <Formik
                                ...
                                initialValues={{
                                  ...
                                  Select_schemes:
                                    (this.state && this.state.Select_schemes) ||
                                    "",
                                  department:
                                  ...
                                  <Form className="form-horizontal">
                                          ...
                                          <Col sm={6} md={6} xl={6}>
                                            ...
                                            <div className="mb-3">
                                              <Label
                                                ...
                                                className="form-label"
                                              >
                                                Are you registering lab for the
                                                first time?
                                              </Label>
                                              <Field
                                    ...
                                    <div className="mb-3">
                                      ...
                                      <Field
                                        ...
                                        onChange={e =>
                                          this.setState({
                                            Select_schemes: e.target.value,
                                          })
                                        }
                                        defaultValue={this.state.Select_schemes}
                                        className="form-select"
                                      >
                                        ...
                                        <div className="mt-2">
                                          <div className="input-group auth-pass-inputgroup">
                                            ...
                                            <button
                                              ...
                                              onClick={
                                                this.togglePassword2Visibility
