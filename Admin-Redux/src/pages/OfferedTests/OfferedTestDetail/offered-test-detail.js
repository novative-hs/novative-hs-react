...
class OfferedTestDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      miniCards: [
    ...
    return (
      <React.Fragment>
        <div className="page-content">
          <MetaTags>
            <title>Detail | Offered Test</title>
          </MetaTags>
          <Container fluid>
            {/* Render Breadcrumbs */}
            <Breadcrumbs title="Offered Tests" breadcrumbItem="Test Detail" />
