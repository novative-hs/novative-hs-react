...
class SampleCollectorProfile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      miniCards: [
    ...
    return (
      <React.Fragment>
        <div className="page-content">
          <MetaTags>
            <title>Sample Collector Profile | Ilaaj4u</title>
          </MetaTags>
          <Container fluid>
            {/* Render Breadcrumbs */}
            <Breadcrumbs
              title="Sample Collectors"
              breadcrumbItem="Collector Profile"
            />
...
SampleCollectorProfile.propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(SampleCollectorProfile));
