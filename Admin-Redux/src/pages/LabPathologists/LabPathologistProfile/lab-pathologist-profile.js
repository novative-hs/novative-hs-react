...
class LabPathologistProfile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      miniCards: [
    ...
    return (
      <React.Fragment>
        <div className="page-content">
          <MetaTags>
            <title>Lab Pathologist Profile | Ilaaj4u</title>
          </MetaTags>
          <Container fluid>
            {/* Render Breadcrumbs */}
            <Breadcrumbs
              title="Lab Pathologists"
              breadcrumbItem="Pathologist Profile"
            />
...
LabPathologistProfile.propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(LabPathologistProfile));
