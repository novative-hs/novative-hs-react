...
/* OFFERED TESTS PROFILE */
export const GET_OFFERED_TEST_PROFILE = "GET_OFFERED_TEST_PROFILE";
export const GET_OFFERED_TEST_PROFILE_SUCCESS =
  "GET_OFFERED_TEST_PROFILE_SUCCESS";
export const GET_OFFERED_TEST_PROFILE_FAIL = "GET_OFFERED_TEST_PROFILE_FAIL";
