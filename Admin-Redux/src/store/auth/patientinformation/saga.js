...
import { addPatientInformationSuccessful, addPatientInformationFailed } from "./actions"
...
function* addPatientInformation({ payload: { patient, id } }) {
  try {
    const response = yield call(postPatientInformation, API_URL + "/patient/patient-information/" + id, patient)
